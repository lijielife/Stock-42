 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Navigation/Container.php';
...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
    ...
    public static function factory($options)
    {
        ...
        if ($hasMvc) {
            require_once PHP_LIBRARY_PATH.'Zend/Navigation/Page/Mvc.php';
            return new Zend_Navigation_Page_Mvc($options);
        } elseif ($hasUri) {
            require_once PHP_LIBRARY_PATH.'Zend/Navigation/Page/Uri.php';
