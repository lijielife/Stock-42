 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/ProgressBar/Adapter.php';

/**
 * @see Zend_Text_MultiByte
 */
require_once PHP_LIBRARY_PATH.'Zend/Text/MultiByte.php';
...
class Zend_ProgressBar_Adapter_Console extends Zend_ProgressBar_Adapter
{
    ...
    public function setOutputStream($resource)
    {
       ...
       if ($stream === false) {
            require_once PHP_LIBRARY_PATH.'Zend/ProgressBar/Adapter/Exception.php';
