...
/** Zend_Pdf_Page */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Page.php';

/** Zend_Pdf_Style */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Style.php';

/** Zend_Pdf_Color_GrayScale */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Color/GrayScale.php';

/** Zend_Pdf_Color_Rgb */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Color/Rgb.php';

/** Zend_Pdf_Color_Cmyk */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Color/Cmyk.php';

/** Zend_Pdf_Color_Html */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Color/Html.php';

/** Zend_Pdf_Image */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Image.php';

/** Zend_Pdf_Font */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Font.php';

/** Zend_Pdf_Resource_Extractor */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Extractor.php';

/** Zend_Pdf_Canvas */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Canvas.php';


/** Internally used classes */
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Array.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/String/Binary.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Boolean.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Dictionary.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Name.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Null.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Numeric.php';
require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/String.php';
  ...
  /**** Class Constants ****/
    ...
    static public function getMemoryManager()
    {
        if (self::$_memoryManager === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Memory.php';
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/ElementFactory.php';
        $this->_objFactory = Zend_Pdf_ElementFactory::createFactory(1);

        if ($source !== null) {
            require_once PHP_LIBRARY_PATH.'Zend/Pdf/Parser.php';
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Pdf/Trailer/Generator.php';
    ...
    protected function _loadNamedDestinations(Zend_Pdf_Element_Reference $root, $pdfHeaderVersion)
    {
        ...
        if ($versionIs_1_2_plus) {
            ...
            if ($root->Names !== null  &&  $root->Names->Dests !== null) {
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/NameTree.php';
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Target.php';
    ...
    protected function _loadOutlines(Zend_Pdf_Element_Reference $root)
    {
        ...
        while ($outlineDictionary !== null  &&  !$processedDictionaries->contains($outlineDictionary)) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Pdf/Outline/Loaded.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/RecursivelyIteratableObjectsContainer.php';
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                // Try to extract font
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Font/Extracted.php';
