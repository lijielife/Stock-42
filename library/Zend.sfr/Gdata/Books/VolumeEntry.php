 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Comments.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Creator
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Creator.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Date
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Date.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Description
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Description.php';

/**
 * @see Zend_Gdata_Books_Extension_Embeddability
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/Extension/Embeddability.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Format
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Format.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Identifier
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Identifier.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Language
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Language.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Publisher
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Publisher.php';

/**
 * @see Zend_Gdata_Extension_Rating
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Rating.php';

/**
 * @see Zend_Gdata_Books_Extension_Review
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/Extension/Review.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Subject
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Subject.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Title
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore/Extension/Title.php';

/**
 * @see Zend_Gdata_Books_Extension_Viewability
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/Extension/Viewability.php';
...
class Zend_Gdata_Books_VolumeEntry extends Zend_Gdata_Entry
{
    ...
    public function getVolumeId()
    {
        ...
        if ($position === false) {
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Exception.php';
