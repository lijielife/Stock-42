 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Media.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/VideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_CommentFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/CommentFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistListFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/PlaylistListFeed.php';

/**
 * @see Zend_Gdata_YouTube_SubscriptionFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/SubscriptionFeed.php';

/**
 * @see Zend_Gdata_YouTube_ContactFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/ContactFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/PlaylistVideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_ActivityFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/ActivityFeed.php';

/**
 * @see Zend_Gdata_YouTube_InboxFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/YouTube/InboxFeed.php';
...
class Zend_Gdata_YouTube extends Zend_Gdata_Media
{
        ...
        $developerKey = null)
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/HttpException.php';
