 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/DublinCore.php';

/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/CollectionEntry.php';

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/CollectionFeed.php';

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/VolumeEntry.php';

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Books/VolumeFeed.php';
