 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Where.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Who.php';

/**
 * @see Zend_Gdata_Extension_Recurrence
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Recurrence.php';

/**
 * @see Zend_Gdata_Extension_EventStatus
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/EventStatus.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Transparency.php';

/**
 * @see Zend_Gdata_Extension_Visibility
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/Visibility.php';

/**
 * @see Zend_Gdata_Extension_ExtendedProperty
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/ExtendedProperty.php';

/**
 * @see Zend_Gdata_Extension_OriginalEvent
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/OriginalEvent.php';
...
class Zend_Gdata_Kind_EventEntry extends Zend_Gdata_Entry
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gd') . ':' . 'recurrenceException';
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/Extension/RecurrenceException.php';
