 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/Access.php';

/**
 * @see Zend_Gdata_Photos_Extension_BytesUsed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/BytesUsed.php';

/**
 * @see Zend_Gdata_Photos_Extension_Location
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/Location.php';

/**
 * @see Zend_Gdata_Photos_Extension_Name
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/Name.php';

/**
 * @see Zend_Gdata_Photos_Extension_NumPhotos
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/NumPhotos.php';

/**
 * @see Zend_Gdata_Photos_Extension_NumPhotosRemaining
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/Extension/NumPhotosRemaining.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Media/Extension/MediaGroup.php';
