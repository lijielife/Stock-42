 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gbase/ItemFeed.php';

/**
 * @see Zend_Gdata_Gbase_ItemEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gbase/ItemEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gbase/SnippetEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gbase/SnippetFeed.php';
