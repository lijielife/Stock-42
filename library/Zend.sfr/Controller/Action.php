 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Action/Interface.php';
...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    public function initView()
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/View/Interface.php';
        ...
        require_once PHP_LIBRARY_PATH.'Zend/View.php';
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Controller/Action/Exception.php';
