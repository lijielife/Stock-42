...
require_once PHP_LIBRARY_PATH.'Zend/Controller/Router/Abstract.php';

/** Zend_Controller_Router_Route */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Router/Route.php';
    ...
    public function addConfig(Zend_Config $config, $section = null)
    {
        if ($section !== null) {
            if ($config->{$section} === null) {
                require_once PHP_LIBRARY_PATH.'Zend/Controller/Router/Exception.php';
