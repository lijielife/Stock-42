 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Action/Helper/Abstract.php';
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Filter/Inflector.php';
            /**
             * @see Zend_Filter_PregReplace
             */
            require_once PHP_LIBRARY_PATH.'Zend/Filter/PregReplace.php';
            /**
             * @see Zend_Filter_Word_UnderscoreToSeparator
             */
            require_once PHP_LIBRARY_PATH.'Zend/Filter/Word/UnderscoreToSeparator.php';
