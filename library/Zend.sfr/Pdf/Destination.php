...
abstract class Zend_Pdf_Destination extends Zend_Pdf_Target
{
    ...
    public static function load(Zend_Pdf_Element $resource)
    {
        ...
        if ($resource->getType() == Zend_Pdf_Element::TYPE_NAME  ||  $resource->getType() == Zend_Pdf_Element::TYPE_STRING) {
            require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/Named.php';
        ...
        switch ($resource->items[1]->value) {
            case 'XYZ':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/Zoom.php';
                return new Zend_Pdf_Destination_Zoom($resource);
                break;

            case 'Fit':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/Fit.php';
                return new Zend_Pdf_Destination_Fit($resource);
                break;

            case 'FitH':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitHorizontally.php';
                return new Zend_Pdf_Destination_FitHorizontally($resource);
                break;

            case 'FitV':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitVertically.php';
                return new Zend_Pdf_Destination_FitVertically($resource);
                break;

            case 'FitR':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitRectangle.php';
                return new Zend_Pdf_Destination_FitRectangle($resource);
                break;

            case 'FitB':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitBoundingBox.php';
                return new Zend_Pdf_Destination_FitBoundingBox($resource);
                break;

            case 'FitBH':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitBoundingBoxHorizontally.php';
                return new Zend_Pdf_Destination_FitBoundingBoxHorizontally($resource);
                break;

            case 'FitBV':
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/FitBoundingBoxVertically.php';
                return new Zend_Pdf_Destination_FitBoundingBoxVertically($resource);
                break;

            default:
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Destination/Unknown.php';
