...
abstract class Zend_Pdf_Image
{
  ...
  /* Factory Methods */
    ...
    public static function imageWithPath($filePath)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/ImageFactory.php';
    ...
    protected static function _extractJpegImage($dataSource)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/FileParser/Image/Jpeg.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Jpeg($dataSource);
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Image/Jpeg.php';
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/FileParser/Image/Png.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Png($dataSource);
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Image/Png.php';
    ...
    protected static function _extractTiffImage($dataSource)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/FileParser/Image/Tiff.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Tiff($dataSource);
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Image/Tiff.php';
