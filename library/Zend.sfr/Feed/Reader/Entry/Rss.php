 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader.php';

/**
 * @see Zend_Feed_Reader_EntryInterface
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/EntryInterface.php';

/**
 * @see Zend_Feed_Reader_EntryAbstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/EntryAbstract.php';

/**
 * @see Zend_Feed_Reader_Extension_DublinCore_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/DublinCore/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Content_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/Content/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Atom_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/Atom/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_WellformedWeb_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/WellFormedWeb/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Slash_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/Slash/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Thread_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Extension/Thread/Entry.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Collection/Category.php';
                    ...
                    foreach ($dateStandards as $standard) {
                        try {
                            ...
                            if ($standard == Zend_Date::DATES) {
                                require_once PHP_LIBRARY_PATH.'Zend/Feed/Exception.php';
