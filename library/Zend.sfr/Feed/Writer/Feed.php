 ...
 * @see Zend_Date
 */
require_once PHP_LIBRARY_PATH.'Zend/Uri.php';

/**
 * @see Zend_Feed_Writer
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer.php';

/**
 * @see Zend_Feed_Writer_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Entry.php';

/**
 * @see Zend_Feed_Writer_Deleted
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Deleted.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Atom
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/Feed/Atom.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Rss
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/Feed/Rss.php';

require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Feed/FeedAbstract.php';
