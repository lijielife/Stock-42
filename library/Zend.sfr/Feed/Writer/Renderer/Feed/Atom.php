...
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Feed.php';

/** @see Zend_Version */
require_once PHP_LIBRARY_PATH.'Zend/Version.php';

/** @see Zend_Feed_Writer_Renderer_RendererInterface */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/RendererInterface.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/Entry/Atom.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom_Deleted */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/Entry/Atom/Deleted.php';

/** @see Zend_Feed_Writer_Renderer_RendererAbstract */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/RendererAbstract.php';

require_once PHP_LIBRARY_PATH.'Zend/Feed/Writer/Renderer/Feed/Atom/AtomAbstract.php';
