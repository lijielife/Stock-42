 ...
 * @see Zend_Feed
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Reader/FeedSet.php';
