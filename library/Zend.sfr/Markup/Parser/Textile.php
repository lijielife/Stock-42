 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Markup/TokenList.php';

/**
 * @see Zend_Markup_Parser_ParserInterface
 */
require_once PHP_LIBRARY_PATH.'Zend/Markup/Parser/ParserInterface.php';
...
class Zend_Markup_Parser_Textile implements Zend_Markup_Parser_ParserInterface
{
    ...
    public function parse($value)
    {
        if (!is_string($value)) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Markup/Parser/Exception.php';
