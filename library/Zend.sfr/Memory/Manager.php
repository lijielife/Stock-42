...
require_once PHP_LIBRARY_PATH.'Zend/Memory/Container/Movable.php';

/** Zend_Memory_Container_Locked */
require_once PHP_LIBRARY_PATH.'Zend/Memory/Container/Locked.php';

/** Zend_Memory_AccessController */
require_once PHP_LIBRARY_PATH.'Zend/Memory/AccessController.php';
...
class Zend_Memory_Manager
{
    ...
    private function _swapCheck()
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Memory/Exception.php';
