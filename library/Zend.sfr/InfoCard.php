 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Xml/EncryptedData.php';

/**
 * Zend_InfoCard_Xml_Assertion
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Xml/Assertion.php';

/**
 * Zend_InfoCard_Cipher
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Cipher.php';

/**
 * Zend_InfoCard_Xml_Security
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Xml/Security.php';

/**
 * Zend_InfoCard_Adapter_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Adapter/Interface.php';

/**
 * Zend_InfoCard_Claims
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Claims.php';
...
class Zend_InfoCard
{
    ...
    public function getAdapter()
    {
        if($this->_adapter === null) {
            require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Adapter/Default.php';
