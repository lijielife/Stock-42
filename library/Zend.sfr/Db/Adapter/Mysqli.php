 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Db/Profiler.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Db/Statement/Mysqli.php';
...
class Zend_Db_Adapter_Mysqli extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Db/Adapter/Mysqli/Exception.php';
