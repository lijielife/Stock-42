 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile/Resource/SearchConstraints.php';
            ...
            if (strtolower($currentResource->getName()) == strtolower($currentConstraint->name)) {
                ...
                if (count($currentConstraint->params) > 0) {
                    ...
                    if (!is_array($currentConstraint->params)) {
                        require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile/Exception.php';
