 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Router/Route/Interface.php';

/**
 * @see Zend_Controller_Router_Route_Module
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Router/Route/Module.php';

/**
 * @see Zend_Controller_Dispatcher_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Dispatcher/Interface.php';

/**
 * @see Zend_Controller_Request_Abstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Request/Abstract.php';
