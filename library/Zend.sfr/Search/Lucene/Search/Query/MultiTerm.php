...
require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Search/Query.php';
...
class Zend_Search_Lucene_Search_Query_MultiTerm extends Zend_Search_Lucene_Search_Query
{
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Search/Weight/MultiTerm.php';
    ...
    private function _calculateConjunctionResult(Zend_Search_Lucene_Interface $reader)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Index/DocsFilter.php';
