...
class Zend_Search_Lucene_Index_Writer
{
    ...
    public function addDocument(Zend_Search_Lucene_Document $document)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Index/SegmentWriter/DocumentWriter.php';
    ...
    private function _mergeSegments($segments)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Index/SegmentMerger.php';
