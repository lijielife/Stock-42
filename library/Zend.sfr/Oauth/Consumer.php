...
/** Zend_Oauth */
require_once PHP_LIBRARY_PATH.'Zend/Oauth.php';

/** Zend_Uri */
require_once PHP_LIBRARY_PATH.'Zend/Uri.php';

/** Zend_Oauth_Http_RequestToken */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Http/RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Http/UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Http/AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Token/AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once PHP_LIBRARY_PATH.'Zend/Oauth/Exception.php';
