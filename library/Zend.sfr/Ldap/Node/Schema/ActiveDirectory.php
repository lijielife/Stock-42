 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Schema/AttributeType/ActiveDirectory.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_ActiveDirectory
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Schema/ObjectClass/ActiveDirectory.php';
