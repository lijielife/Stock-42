...
require_once PHP_LIBRARY_PATH.'Zend/Serializer/Adapter/AdapterAbstract.php';

/** @see Zend_Amf_Parse_OutputStream */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Parse/OutputStream.php';

/** @see Zend_Amf_Parse_Amf0_Serializer */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Parse/Amf0/Serializer.php';
