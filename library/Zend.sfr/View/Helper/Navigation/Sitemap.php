 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/View/Helper/Navigation/HelperAbstract.php';
    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function setServerUrl($serverUrl)
    {
        ...
        if ($uri->valid()) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Uri/Exception.php';
    ...
    public function getDomSitemap(Zend_Navigation_Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            require_once PHP_LIBRARY_PATH.'Zend/Validate/Sitemap/Changefreq.php';
            require_once PHP_LIBRARY_PATH.'Zend/Validate/Sitemap/Lastmod.php';
            require_once PHP_LIBRARY_PATH.'Zend/Validate/Sitemap/Loc.php';
            require_once PHP_LIBRARY_PATH.'Zend/Validate/Sitemap/Priority.php';
