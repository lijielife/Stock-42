...
require_once PHP_LIBRARY_PATH.'Zend/View/Helper/Placeholder/Container/Abstract.php';

/** Zend_View_Helper_Placeholder_Container */
require_once PHP_LIBRARY_PATH.'Zend/View/Helper/Placeholder/Container.php';
...
class Zend_View_Helper_Placeholder_Registry
{
    ...
    public function setContainerClass($name)
    {
        ...
        if (!$reflection->isSubclassOf(new ReflectionClass('Zend_View_Helper_Placeholder_Container_Abstract'))) {
            require_once PHP_LIBRARY_PATH.'Zend/View/Helper/Placeholder/Registry/Exception.php';
