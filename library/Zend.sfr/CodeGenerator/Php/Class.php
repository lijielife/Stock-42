 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/CodeGenerator/Php/Abstract.php';

/**
 * @see Zend_CodeGenerator_Php_Member_Container
 */
require_once PHP_LIBRARY_PATH.'Zend/CodeGenerator/Php/Member/Container.php';

/**
 * @see Zend_CodeGenerator_Php_Method
 */
require_once PHP_LIBRARY_PATH.'Zend/CodeGenerator/Php/Method.php';

/**
 * @see Zend_CodeGenerator_Php_Property
 */
require_once PHP_LIBRARY_PATH.'Zend/CodeGenerator/Php/Property.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock
 */
require_once PHP_LIBRARY_PATH.'Zend/CodeGenerator/Php/Docblock.php';
