 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Http/Client/Adapter/Interface.php';
/**
 * @see Zend_Http_Client_Adapter_Stream
 */
require_once PHP_LIBRARY_PATH.'Zend/Http/Client/Adapter/Stream.php';
...
class Zend_Http_Client_Adapter_Socket implements Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function setConfig($config = array())
    {
        if ($config instanceof Zend_Config) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Http/Client/Adapter/Exception.php';
