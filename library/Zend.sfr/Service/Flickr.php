...
class Zend_Service_Flickr
{
    ...
    public function tagSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Flickr/ResultSet.php';
    ...
    public function getImageDetails($id)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Flickr/Image.php';
    ...
    protected function _validateUserSearch(array $options)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Validate/Int.php';
