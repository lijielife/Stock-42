 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Credentials/SharedAccessSignature.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/BlobContainer.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobInstance
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/BlobInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_PageRegionInstance
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/PageRegionInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_LeaseInstance
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/LeaseInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_SignedIdentifier
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/SignedIdentifier.php';
...
class Zend_Service_WindowsAzure_Storage_Blob extends Zend_Service_WindowsAzure_Storage
{
	...
	public function registerStreamWrapper($name = 'azure')
	{
		 ...
		 */
		require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/Blob/Stream.php';
