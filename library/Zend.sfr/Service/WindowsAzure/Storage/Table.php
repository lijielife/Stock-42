 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Credentials/CredentialsAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedKey
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Credentials/SharedKey.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedKeyLite
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Credentials/SharedKeyLite.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BatchStorageAbstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/BatchStorageAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableInstance
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/TableInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntity
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/TableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_DynamicTableEntity
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/DynamicTableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntityQuery
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Storage/TableEntityQuery.php';

/**
 * @see Zend_Service_WindowsAzure_Exception
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/Exception.php';
