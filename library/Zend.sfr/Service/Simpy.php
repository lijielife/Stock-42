...
class Zend_Service_Simpy
{
    ...
    public function getTags($limit = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Simpy/TagSet.php';
    ...
    public function getLinks(Zend_Service_Simpy_LinkQuery $q = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Simpy/LinkSet.php';
    ...
    public function getWatchlists()
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Simpy/WatchlistSet.php';
    ...
    public function getNotes($q = null, $limit = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Simpy/NoteSet.php';
