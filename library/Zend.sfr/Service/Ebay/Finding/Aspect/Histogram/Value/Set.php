 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Set/Abstract.php';
...
class Zend_Service_Ebay_Finding_Aspect_Histogram_Value_Set extends Zend_Service_Ebay_Finding_Set_Abstract
{
    ...
    public function current()
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Aspect/Histogram/Value.php';
