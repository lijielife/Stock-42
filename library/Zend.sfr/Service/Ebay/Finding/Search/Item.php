 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Abstract.php';
...
class Zend_Service_Ebay_Finding_Search_Item extends Zend_Service_Ebay_Finding_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/ListingInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Category.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/SellerInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/SellingStatus.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/ShippingInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Storefront.php';
