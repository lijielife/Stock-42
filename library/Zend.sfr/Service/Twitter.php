 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Rest/Client/Result.php';

/**
 * @see Zend_Oauth_Consumer
 */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Consumer.php';
...
class Zend_Service_Twitter extends Zend_Rest_Client
{
    ...
    protected function _init()
    {
        if (!$this->isAuthorised() && $this->getUsername() !== null) {
            require_once PHP_LIBRARY_PATH.'Zend/Service/Twitter/Exception.php';
            throw new Zend_Service_Twitter_Exception(
    ...
    protected function _prepare($path)
    {
        ...
        if (!$this->_uri instanceof Zend_Uri_Http) {
            require_once PHP_LIBRARY_PATH.'Zend/Rest/Client/Exception.php';
