...
class Zend_Service_Technorati
{
    ...
    public function cosmos($url, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/CosmosResultSet.php';
    ...
    public function search($query, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/SearchResultSet.php';
    ...
    public function tag($tag, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/TagResultSet.php';
    ...
    public function dailyCounts($query, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/DailyCountsResultSet.php';
    ...
    public function topTags($options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/TagsResultSet.php';
    ...
    public function blogInfo($url, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/BlogInfoResult.php';
    ...
    public function getInfo($username, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/GetInfoResult.php';
    ...
    public function keyInfo()
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/KeyInfoResult.php';
    ...
    protected function _validateDailyCounts(array $options)
    {
        ...
        if (isset($options['days'])) {
            ...
            if ($options['days'] < self::PARAM_DAYS_MIN_VALUE ||
                 ...
                 */
                require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/Exception.php';
