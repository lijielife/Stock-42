...
class Zend_Service_Amazon_Item
{
    ...
    {
        if (null === $dom) {
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/Exception.php';
        ...
        foreach (array('SmallImage', 'MediumImage', 'LargeImage') as $im) {
            ...
            if ($result->length == 1) {
                 ...
                 */
                require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/Image.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/CustomerReview.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/EditorialReview.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/SimilarProduct.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/ListmaniaList.php';
            foreach ($result as $r) {
        ...
        if ($result->length > 1 || $resultSummary->length == 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/OfferSet.php';
        ...
        if ($result->length > 1) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/Accessories.php';
            foreach ($result as $r) {
