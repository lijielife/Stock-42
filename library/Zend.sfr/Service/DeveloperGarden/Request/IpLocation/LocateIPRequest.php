 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/RequestAbstract.php';

/**
 * @see Zend_Service_DeveloperGarden_IpLocation_IpAddress
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/IpLocation/IpAddress.php';
        ...
        if (is_array($ip)) {
            foreach ($ip as $ipObject) {
                if (!$ipObject instanceof Zend_Service_DeveloperGarden_IpLocation_IpAddress
                    ...
                    require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/Exception.php';
