 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SmsValidation/GetValidatedNumbers.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SmsValidation_GetValidatedNumbersResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SmsValidation/GetValidatedNumbersResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SmsValidation_ValidatedNumber
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SmsValidation/ValidatedNumber.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SmsValidation_SendValidationKeyword
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SmsValidation/SendValidationKeyword.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SmsValidation_SendValidationKeywordResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SmsValidation/SendValidationKeywordResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SmsValidation_Validate
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SmsValidation/Validate.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SmsValidation_ValidateResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SmsValidation/ValidateResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SmsValidation_Invalidate
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SmsValidation/Invalidate.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SmsValidation_InvalidateResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SmsValidation/InvalidateResponse.php';
