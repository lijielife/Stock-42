 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/LocalSearch/LocalSearchResponseType.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_LocalSearch_LocalSearchRequest
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/LocalSearch/LocalSearchRequest.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_LocalSearch_LocalSearchResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/LocalSearch/LocalSearchResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_LocalSearch_SearchParameters
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/LocalSearch/SearchParameters.php';
