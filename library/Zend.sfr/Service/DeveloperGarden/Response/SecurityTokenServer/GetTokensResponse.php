 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/ResponseAbstract.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SecurityTokenServer/Interface.php';
    ...
    implements Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
{
    ...
    public function getSecurityToken()
    {
        if (!$this->securityToken instanceof Zend_Service_DeveloperGarden_Response_SecurityTokenServer_SecurityTokenResponse) {
            require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SecurityTokenServer/Exception.php';
