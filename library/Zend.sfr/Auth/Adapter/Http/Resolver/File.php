 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Auth/Adapter/Http/Resolver/Interface.php';
...
class Zend_Auth_Adapter_Http_Resolver_File implements Zend_Auth_Adapter_Http_Resolver_Interface
{
    ...
    public function setFile($path)
    {
        if (empty($path) || !is_readable($path)) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Auth/Adapter/Http/Resolver/Exception.php';
