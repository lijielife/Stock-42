 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Queue/Adapter/AdapterAbstract.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Queue/Adapter/Db/Queue.php';

/**
 * @see Zend_Queue_Adapter_Db_Message
 */
require_once PHP_LIBRARY_PATH.'Zend/Queue/Adapter/Db/Message.php';
