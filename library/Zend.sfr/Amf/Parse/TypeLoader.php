 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/Messaging/AsyncMessage.php';
/**
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/Messaging/RemotingMessage.php';
...
final class Zend_Amf_Parse_TypeLoader
{
    ...
    {
        if(!self::$_resourceLoader) {
            require_once PHP_LIBRARY_PATH.'Zend/Amf/Exception.php';
