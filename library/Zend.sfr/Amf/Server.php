...
require_once PHP_LIBRARY_PATH.'Zend/Server/Interface.php';

/** @see Zend_Server_Reflection */
require_once PHP_LIBRARY_PATH.'Zend/Server/Reflection.php';

/** @see Zend_Amf_Constants */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Constants.php';

/** @see Zend_Amf_Value_MessageBody */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/MessageBody.php';

/** @see Zend_Amf_Value_MessageHeader */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/MessageHeader.php';

/** @see Zend_Amf_Value_Messaging_CommandMessage */
require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/Messaging/CommandMessage.php';
...
/** @see Zend_Auth */
require_once PHP_LIBRARY_PATH.'Zend/Auth.php';
/**
...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Session.php';
        $this->_session = true;
    ...
    protected function _checkAcl($object, $function)
    {
        ...
        if($object) {
            ...
            if(!$this->_acl->has($class)) {
                require_once PHP_LIBRARY_PATH.'Zend/Acl/Resource.php';
        ...
        if($auth->hasIdentity()) {
            ...
            if($this->_acl->hasRole(Zend_Amf_Constants::GUEST_ROLE)) {
                ...
                require_once PHP_LIBRARY_PATH.'Zend/Amf/Server/Exception.php';
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/Messaging/AcknowledgeMessage.php';
    ...
    protected function _errorMessage($objectEncoding, $message, $description, $detail, $code, $line)
    {
        ...
        switch ($objectEncoding) {
            ...
            case Zend_Amf_Constants::AMF3_OBJECT_ENCODING :
                require_once PHP_LIBRARY_PATH.'Zend/Amf/Value/Messaging/ErrorMessage.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once PHP_LIBRARY_PATH.'Zend/Amf/Request/Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once PHP_LIBRARY_PATH.'Zend/Amf/Response/Http.php';
