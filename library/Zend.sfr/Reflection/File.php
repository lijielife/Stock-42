 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Reflection/Class.php';

/**
 * @see Zend_Reflection_Function
 */
require_once PHP_LIBRARY_PATH.'Zend/Reflection/Function.php';
...
class Zend_Reflection_File implements Reflector
{
    ...
    public function __construct($file)
    {
        ...
        if (($filecleanPath = cleanPath($fileName)) === false) {
            $filecleanPath = self::findcleanPathInIncludePath($file);
        }

        if (!$filecleanPath || !in_array($filecleanPath, get_included_files())) {
