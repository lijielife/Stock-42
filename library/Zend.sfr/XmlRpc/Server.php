 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Server/Abstract.php';

/**
 * XMLRPC Request
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Request.php';

/**
 * XMLRPC Response
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Response.php';

/**
 * XMLRPC HTTP Response
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Response/Http.php';

/**
 * XMLRPC server fault class
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Server/Fault.php';

/**
 * XMLRPC server system methods class
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Server/System.php';

/**
 * Convert PHP to and from xmlrpc native types
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Value.php';

/**
 * Reflection API for function/method introspection
 */
require_once PHP_LIBRARY_PATH.'Zend/Server/Reflection.php';

/**
 * Zend_Server_Reflection_Function_Abstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Server/Reflection/Function/Abstract.php';
 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Server/Reflection/Method.php';
 ...
 * Example:
 * <code>
 * require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Server.php';
 * require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Server/Cache.php';
 * require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Server/Fault.php';
 * require_once PHP_LIBRARY_PATH.'My/Exception.php';
 * require_once PHP_LIBRARY_PATH.'My/Fault/Observer.php';
 *
 * // Instantiate server
 ...
 *     require_once PHP_LIBRARY_PATH.'Some/Service/Class.php';
 *     require_once PHP_LIBRARY_PATH.'Another/Service/Class.php';
 *
...
class Zend_XmlRpc_Server extends Zend_Server_Abstract
{
    ...
    public function handle($request = false)
    {
        ...
        if ((!$request || !$request instanceof Zend_XmlRpc_Request)
            ...
            require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Request/Http.php';
