 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Client/ServerProxy.php';

/**
 * Introspects remote servers using the XML-RPC de facto system.* methods
 * @see Zend_XmlRpc_Client_ServerIntrospection
 */
require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Client/ServerIntrospection.php';
   ...
   /**
    ...
    public function doRequest($request, $response = null)
    {
        ...
        if (! $httpResponse->isSuccessful()) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Client/HttpException.php';
    ...
    public function call($method, $params=array())
    {
        ...
        if ($this->_lastResponse->isFault()) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/XmlRpc/Client/FaultException.php';
