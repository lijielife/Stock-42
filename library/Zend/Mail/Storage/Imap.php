 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Storage/Abstract.php';

/**
 * @see Zend_Mail_Protocol_Imap
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Protocol/Imap.php';

/**
 * @see Zend_Mail_Storage_Writable_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Storage/Writable/Interface.php';

/**
 * @see Zend_Mail_Storage_Folder_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Storage/Folder/Interface.php';

/**
 * @see Zend_Mail_Storage_Folder
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Storage/Folder.php';

/**
 * @see Zend_Mail_Message
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Message.php';

/**
 * @see Zend_Mail_Storage
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Storage.php';
