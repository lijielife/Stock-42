...
require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Search/Query/Preprocessing.php';
...
class Zend_Search_Lucene_Search_Query_Preprocessing_Fuzzy extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    public function rewrite(Zend_Search_Lucene_Interface $index)
    {
        if ($this->_field === null) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene.php';
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Search/Lucene/Search/Query/Preprocessing/Fuzzy.php';
