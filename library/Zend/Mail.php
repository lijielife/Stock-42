 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Mail/Transport/Abstract.php';

/**
 * @see Zend_Mime
 */
require_once PHP_LIBRARY_PATH.'Zend/Mime.php';

/**
 * @see Zend_Mime_Message
 */
require_once PHP_LIBRARY_PATH.'Zend/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once PHP_LIBRARY_PATH.'Zend/Mime/Part.php';
    ...
    public function send($transport = null)
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof Zend_Mail_Transport_Abstract) {
                require_once PHP_LIBRARY_PATH.'Zend/Mail/Transport/Sendmail.php';
