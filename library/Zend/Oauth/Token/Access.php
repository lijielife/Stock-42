...
/** Zend_Oauth_Token */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Token.php';

/** Zend_Oauth_Http */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Http.php';

/** Zend_Uri_Http */
require_once PHP_LIBRARY_PATH.'Zend/Uri/Http.php';

/** Zend_Oauth_Client */
require_once PHP_LIBRARY_PATH.'Zend/Oauth/Client.php';
