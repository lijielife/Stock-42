 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Db/Adapter/Abstract.php';

/**
 * @see Zend_Db_Adapter_Abstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Db/Select.php';

/**
 * @see Zend_Db
 */
require_once PHP_LIBRARY_PATH.'Zend/Db.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (!$db instanceof Zend_Db_Adapter_Abstract) {
            require_once PHP_LIBRARY_PATH.'Zend/Db/Table/Exception.php';
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Db/Table/Select.php';
