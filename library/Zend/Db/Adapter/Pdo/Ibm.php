...
require_once PHP_LIBRARY_PATH.'Zend/Db/Adapter/Pdo/Abstract.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Db2 */
require_once PHP_LIBRARY_PATH.'Zend/Db/Adapter/Pdo/Ibm/Db2.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Ids */
require_once PHP_LIBRARY_PATH.'Zend/Db/Adapter/Pdo/Ibm/Ids.php';

/** @see Zend_Db_Statement_Pdo_Ibm */
require_once PHP_LIBRARY_PATH.'Zend/Db/Statement/Pdo/Ibm.php';
