 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Date/DateObject.php';
require_once PHP_LIBRARY_PATH.'Zend/Locale.php';
require_once PHP_LIBRARY_PATH.'Zend/Locale/Format.php';
require_once PHP_LIBRARY_PATH.'Zend/Locale/Math.php';
                ...
                switch($name) {
                    case 'format_type' :
                        if ((strtolower($value) != 'php') && (strtolower($value) != 'iso')) {
                            require_once PHP_LIBRARY_PATH.'Zend/Date/Exception.php';
