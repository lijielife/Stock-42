 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Xml/Security/Transform/Interface.php';
    ...
    implements Zend_InfoCard_Xml_Security_Transform_Interface
{
    ...
    public function transform($strXMLData)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/InfoCard/Xml/Security/Transform/Exception.php';
