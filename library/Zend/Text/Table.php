...
class Zend_Text_Table
{
    ...
    public function __construct($options = null)
    {
        ...
        if ($this->_columnWidths === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Text/Table/Exception.php';
    ...
    public function appendRow($row)
    {
        ...
        if (is_array($row)) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Text/Table/Row.php';
            require_once PHP_LIBRARY_PATH.'Zend/Text/Table/Column.php';
