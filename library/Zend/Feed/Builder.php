 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Builder/Interface.php';

/**
 * @see Zend_Feed_Builder_Header
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Builder/Header.php';

/**
 * @see Zend_Feed_Builder_Entry
 */
require_once PHP_LIBRARY_PATH.'Zend/Feed/Builder/Entry.php';
