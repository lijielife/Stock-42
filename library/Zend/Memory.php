...
require_once PHP_LIBRARY_PATH.'Zend/Memory/Manager.php';

/** Zend_Memory_Value */
require_once PHP_LIBRARY_PATH.'Zend/Memory/Value.php';

/** Zend_Memory_Container */
require_once PHP_LIBRARY_PATH.'Zend/Memory/Container.php';
