...
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/Sqs.php';
require_once PHP_LIBRARY_PATH.'Zend/Cloud/QueueService/Adapter/AbstractAdapter.php';
require_once PHP_LIBRARY_PATH.'Zend/Cloud/QueueService/Exception.php';
require_once PHP_LIBRARY_PATH.'Zend/Cloud/QueueService/Message.php';
