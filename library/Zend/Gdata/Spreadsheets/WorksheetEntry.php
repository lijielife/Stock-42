 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Spreadsheets/Extension/RowCount.php';

/**
 * @see Zend_Gdata_Spreadsheets_Extension_ColCount
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Spreadsheets/Extension/ColCount.php';
