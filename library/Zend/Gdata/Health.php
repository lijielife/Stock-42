 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Health/ProfileFeed.php';

/**
 * @see Zend_Gdata_Health_ProfileListFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Health/ProfileListFeed.php';

/**
 * @see Zend_Gdata_Health_ProfileListEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Health/ProfileListEntry.php';

/**
 * @see Zend_Gdata_Health_ProfileEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Health/ProfileEntry.php';
...
class Zend_Gdata_Health extends Zend_Gdata
{
    ...
    public function getHealthProfileListFeed($query = null)
    {
        if ($this->_httpClient->getClientLoginToken() === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/AuthException.php';
