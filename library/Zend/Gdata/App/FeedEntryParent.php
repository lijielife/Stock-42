...
*/
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Author.php';
...
*/
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/Extension/Updated.php';

/**
 * Zend_Version
 */
require_once PHP_LIBRARY_PATH.'Zend/Version.php';
