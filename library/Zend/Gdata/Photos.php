 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/PhotoFeed.php';
