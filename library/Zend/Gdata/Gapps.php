 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/UserFeed.php';

/**
 * @see Zend_Gdata_Gapps_NicknameFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/NicknameFeed.php';

/**
 * @see Zend_Gdata_Gapps_GroupFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/GroupFeed.php';

/**
 * @see Zend_Gdata_Gapps_MemberFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/MemberFeed.php';

/**
 * @see Zend_Gdata_Gapps_OwnerFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/OwnerFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/EmailListFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListRecipientFeed
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/EmailListRecipientFeed.php';
...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    public static function throwServiceExceptionIfDetected($e) {
        ...
        try {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/Gapps/ServiceException.php';
