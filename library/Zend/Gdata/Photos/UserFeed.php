 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/UserEntry.php';

/**
 * @see Zend_Gdata_Photos_AlbumEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/AlbumEntry.php';

/**
 * @see Zend_Gdata_Photos_PhotoEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/PhotoEntry.php';

/**
 * @see Zend_Gdata_Photos_TagEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/TagEntry.php';

/**
 * @see Zend_Gdata_Photos_CommentEntry
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/Photos/CommentEntry.php';
