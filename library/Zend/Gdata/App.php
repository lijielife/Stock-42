 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Uri/Http.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once PHP_LIBRARY_PATH.'Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once PHP_LIBRARY_PATH.'Zend/Gdata/HttpAdapterStreamingSocket.php';
