...
*/
require_once PHP_LIBRARY_PATH.'Zend/Gdata/MimeFile.php';

/**
* @see Zend_Gdata_MimeBodyString
*/
require_once PHP_LIBRARY_PATH.'Zend/Gdata/MimeBodyString.php';
...
class Zend_Gdata_MediaMimeStream
{
        ...
        $fileContentType = null)
    {
        if (!file_exists($filePath) || !is_readable($filePath)) {
            require_once PHP_LIBRARY_PATH.'Zend/Gdata/App/IOException.php';
