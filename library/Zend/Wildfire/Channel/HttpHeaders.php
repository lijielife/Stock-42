...
require_once PHP_LIBRARY_PATH.'Zend/Wildfire/Channel/Interface.php';
...
require_once PHP_LIBRARY_PATH.'Zend/Controller/Plugin/Abstract.php';

/** Zend_Wildfire_Protocol_JsonStream */
require_once PHP_LIBRARY_PATH.'Zend/Wildfire/Protocol/JsonStream.php';
...
class Zend_Wildfire_Channel_HttpHeaders extends Zend_Controller_Plugin_Abstract implements Zend_Wildfire_Channel_Interface
{
    ...
    public static function init($class = null)
    {
        if (self::$_instance !== null) {
            require_once PHP_LIBRARY_PATH.'Zend/Wildfire/Exception.php';
