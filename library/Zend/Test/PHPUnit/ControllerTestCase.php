...
require_once PHP_LIBRARY_PATH.'PHPUnit/Runner/Version.php';
...
require_once PHP_LIBRARY_PATH.'Zend/Controller/Front.php';

/** @see Zend_Controller_Action_HelperBroker */
require_once PHP_LIBRARY_PATH.'Zend/Controller/Action/HelperBroker.php';

/** @see Zend_Layout */
require_once PHP_LIBRARY_PATH.'Zend/Layout.php';

/** @see Zend_Session */
require_once PHP_LIBRARY_PATH.'Zend/Session.php';

/** @see Zend_Registry */
require_once PHP_LIBRARY_PATH.'Zend/Registry.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Test/PHPUnit/Constraint/DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once PHP_LIBRARY_PATH.'Zend/Test/PHPUnit/Constraint/Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once PHP_LIBRARY_PATH.'Zend/Test/PHPUnit/Constraint/ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once PHP_LIBRARY_PATH.'Zend/Controller/Request/HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            require_once PHP_LIBRARY_PATH.'Zend/Controller/Response/HttpTestCase.php';
    ...
    {
        if (null === $this->_query) {
            require_once PHP_LIBRARY_PATH.'Zend/Dom/Query.php';
