 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Http/UserAgent/Storage.php';

/**
 * @see Zend_Session_Namespace
 */
require_once PHP_LIBRARY_PATH.'Zend/Session/Namespace.php';
...
class Zend_Http_UserAgent_Storage_Session implements Zend_Http_UserAgent_Storage
{
    ...
    public function __construct($options = null)
    {
        ...
        if (null !== $options && !is_array($options)) {
            require_once PHP_LIBRARY_PATH.'Zend/Http/UserAgent/Storage/Exception.php';
