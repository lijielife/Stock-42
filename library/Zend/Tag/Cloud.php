 ...
 * @see Zend_Tag_Item
 */
require_once PHP_LIBRARY_PATH.'Zend/Tag/Item.php';
...
class Zend_Tag_Cloud
{
    ...
    public function setTags(array $tags)
    {
        ...
        foreach ($tags as $tag) {
            if ($tag instanceof Zend_Tag_Taggable) {
                ...
                require_once PHP_LIBRARY_PATH.'Zend/Tag/Cloud/Exception.php';
    ...
    {
        if (null === $this->_tags) {
            require_once PHP_LIBRARY_PATH.'Zend/Tag/ItemList.php';
