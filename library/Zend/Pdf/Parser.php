...
require_once PHP_LIBRARY_PATH.'Zend/Pdf/StringParser.php';
...
class Zend_Pdf_Parser
{
    ...
    private function _loadXRefTable($offset)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Reference/Table.php';
        $refTable = new Zend_Pdf_Element_Reference_Table();
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Element/Reference/Context.php';
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/Trailer/Keeper.php';
