...
abstract class Zend_Pdf_Font
{
  ...
  /* Factory Methods */
    ...
    public static function fontWithPath($filePath, $embeddingOptions = 0)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Pdf/FileParserDataSource/File.php';
  ...
  /* Font Extraction Methods */
    ...
    {
        try {
            require_once PHP_LIBRARY_PATH.'Zend/Pdf/FileParser/Font/OpenType/TrueType.php';
            $fontParser = new Zend_Pdf_FileParser_Font_OpenType_TrueType($dataSource);

            $fontParser->parse();
            if ($fontParser->isAdobeLatinSubset) {
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Font/Simple/Parsed/TrueType.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Parsed_TrueType($fontParser, $embeddingOptions);
            } else {
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Font/CidFont/TrueType.php';
                require_once PHP_LIBRARY_PATH.'Zend/Pdf/Resource/Font/Type0.php';
