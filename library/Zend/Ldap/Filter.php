 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Filter/String.php';
...
class Zend_Ldap_Filter extends Zend_Ldap_Filter_String
{
    ...
    public static function mask($mask, $value)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Filter/Mask.php';
    ...
    public static function andFilter($filter)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Filter/And.php';
    ...
    public static function orFilter($filter)
    {
         ...
         * Zend_Ldap_Filter_Or
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Filter/Or.php';
