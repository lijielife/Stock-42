 ...
 * @see Zend_Ldap
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap.php';
/**
...
class Zend_Ldap_Node extends Zend_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    ...
    */
    ...
    public function searchSubtree($filter, $scope = Zend_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Collection.php';
    ...
    public function getChildren()
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/ChildrenIterator.php';
