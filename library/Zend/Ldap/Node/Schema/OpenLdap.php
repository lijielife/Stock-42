 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Schema/AttributeType/OpenLdap.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_OpenLdap
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Schema/ObjectClass/OpenLdap.php';
