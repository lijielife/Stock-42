 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/Abstract.php';
...
class Zend_Ldap_Node_RootDse extends Zend_Ldap_Node_Abstract
{
    ...
    public static function create(Zend_Ldap $ldap)
    {
        ...
        if (isset($data['domainfunctionality'])) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/RootDse/ActiveDirectory.php';
            return new Zend_Ldap_Node_RootDse_ActiveDirectory($dn, $data);
        } else if (isset($data['dsaname'])) {
            /**
             * @see Zend_Ldap_Node_RootDse_ActiveDirectory
             */
            require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/RootDse/eDirectory.php';
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Ldap/Node/RootDse/OpenLdap.php';
    ...
    public function getSchemaDn()
    {
         ...
         * @see Zend_Ldap_Dn
         */
        require_once PHP_LIBRARY_PATH.'Zend/Ldap/Dn.php';
