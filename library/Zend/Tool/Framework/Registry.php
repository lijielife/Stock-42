 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Registry/Interface.php';
...
//    }
    ...
    public function getConfig()
    {
        if ($this->_config === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Config.php';
    ...
    public function getStorage()
    {
        if ($this->_storage === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Storage.php';
    ...
    public function getLoader()
    {
        if ($this->_loader === null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Loader/IncludePathLoader.php';
    ...
    public function getActionRepository()
    {
        if ($this->_actionRepository == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Action/Repository.php';
    ...
    public function getProviderRepository()
    {
        if ($this->_providerRepository == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Provider/Repository.php';
    ...
    public function getManifestRepository()
    {
        if ($this->_manifestRepository == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Manifest/Repository.php';
    ...
    public function getRequest()
    {
        if ($this->_request == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Request.php';
    ...
    public function getResponse()
    {
        if ($this->_response == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Response.php';
    ...
    public function __get($name)
    {
        if (method_exists($this, 'get' . $name)) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Registry/Exception.php';
