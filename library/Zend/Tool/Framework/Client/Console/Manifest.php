 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Manifest/MetadataManifestable.php';

/**
 * @see Zend_Filter
 */
require_once PHP_LIBRARY_PATH.'Zend/Filter.php';

/**
 * @see Zend_Filter_Word_CamelCaseToDash
 */
require_once PHP_LIBRARY_PATH.'Zend/Filter/Word/CamelCaseToDash.php';

/**
 * @see Zend_Filter_StringToLower
 */
require_once PHP_LIBRARY_PATH.'Zend/Filter/StringToLower.php';

/**
 * @see Zend_Tool_Framework_Metadata_Tool
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Metadata/Tool.php';

/**
 * @see Zend_Tool_Framework_Registry_EnabledInterface
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Registry/EnabledInterface.php';
