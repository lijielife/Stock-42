 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Abstract.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_InputInterface
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Interactive/InputInterface.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_OutputInterface
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Client/Interactive/OutputInterface.php';
