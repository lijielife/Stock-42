 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Provider/Abstract.php';

/**
 * @see Zend_Tool_Framework_Provider_Pretendable
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Provider/Pretendable.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_ContextFilter
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile/Iterator/ContextFilter.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_EnabledResourceFilter
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile/Iterator/EnabledResourceFilter.php';
    ...
    implements Zend_Tool_Framework_Provider_Pretendable
{
    ...
    public function create($name) //, $moduleProfile = null)
    {
        ...
        require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Provider/Test.php';
