 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile.php';

/**
 * @see Zend_Tool_Framework_Provider_Abstract
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Provider/Abstract.php';

/**
 * @see Zend_Tool_Project_Context_Repository
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/Repository.php';

/**
 * @see Zend_Tool_Project_Profile_FileParser_Xml
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Profile/FileParser/Xml.php';

/**
 * @see Zend_Tool_Framework_Registry
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Registry.php';

require_once PHP_LIBRARY_PATH.'Zend/Tool/Framework/Provider/Initializable.php';
    ...
    implements Zend_Tool_Framework_Provider_Initializable
{
    ...
    protected function _findProfileDirectory($projectDirectory = null, $searchParentDirectories = true)
    {
        ...
        } elseif (cleanPath($projectDirectory) == false) {
    ...
    protected function _loadProfileRequired()
    {
        $profile = $this->_loadProfile();
        if ($profile === false) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Provider/Exception.php';
    ...
    protected function _getContentForContext(Zend_Tool_Project_Context_Interface $context, $methodName, $parameters)
    {
        ...
        if (!class_exists('Zend_Tool_Project_Context_Content_Engine')) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/Content/Engine.php';
        }
