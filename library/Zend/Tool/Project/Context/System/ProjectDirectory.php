 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/System/Interface.php';

/**
 * @see Zend_Tool_Project_Context_System_TopLevelRestrictable
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/System/TopLevelRestrictable.php';

/**
 * @see Zend_Tool_Project_Context_System_NotOverwritable
 */
require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/System/NotOverwritable.php';
               ...
               Zend_Tool_Project_Context_System_TopLevelRestrictable
{
    ...
    public function init()
    {
        ...
        // if not, exception.
        if ($projectDirectory == null) {
            require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Exception.php';
            ...
            foreach (new DirectoryIterator($this->getPath()) as $item) {
                if (!$item->isDot()) {
                    if ($registry->getClient()->isInteractive()) {
                        ...
                        require_once PHP_LIBRARY_PATH.'Zend/Tool/Project/Context/Exception.php';
