 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Acl/Resource/Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once PHP_LIBRARY_PATH.'Zend/Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once PHP_LIBRARY_PATH.'Zend/Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once PHP_LIBRARY_PATH.'Zend/Acl/Role.php';
