 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Dom/Query/Css2Xpath.php';

/**
 * @see Zend_Dom_Query_Result
 */
require_once PHP_LIBRARY_PATH.'Zend/Dom/Query/Result.php';
...
class Zend_Dom_Query
{
    ...
    public function queryXpath($xpathQuery, $query = null)
    {
        if (null === ($document = $this->getDocument())) {
            require_once PHP_LIBRARY_PATH.'Zend/Dom/Exception.php';
