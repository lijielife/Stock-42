 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Filter/Encrypt/Interface.php';
...
class Zend_Filter_Encrypt_Mcrypt implements Zend_Filter_Encrypt_Interface
{
    ...
    public function encrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once PHP_LIBRARY_PATH.'Zend/Filter/Compress.php';
    ...
    public function decrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once PHP_LIBRARY_PATH.'Zend/Filter/Decompress.php';
