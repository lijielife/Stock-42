 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Crypt/Rsa/Key/Private.php';

/**
 * @see Zend_Crypt_Rsa_Key_Public
 */
require_once PHP_LIBRARY_PATH.'Zend/Crypt/Rsa/Key/Public.php';
...
class Zend_Crypt_Rsa
{
    ...
    public function __construct(array $options = null)
    {
        if (!extension_loaded('openssl')) {
            require_once PHP_LIBRARY_PATH.'Zend/Crypt/Rsa/Exception.php';
