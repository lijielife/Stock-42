...
/** @see Zend_Form */
require_once PHP_LIBRARY_PATH.'Zend/Form.php';

/** @see Zend_Validate_Interface */
require_once PHP_LIBRARY_PATH.'Zend/Validate/Interface.php';

/** @see Zend_Validate_Abstract */
require_once PHP_LIBRARY_PATH.'Zend/Validate/Abstract.php';
...
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Form/Element/Exception.php';
