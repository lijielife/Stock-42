...
class Zend_Json_Server extends Zend_Server_Abstract
{
    ...
    {
        require_once PHP_LIBRARY_PATH.'Zend/Json/Server/Error.php';
    ...
    public function getRequest()
    {
        if (null === ($request = $this->_request)) {
            require_once PHP_LIBRARY_PATH.'Zend/Json/Server/Request/Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once PHP_LIBRARY_PATH.'Zend/Json/Server/Response/Http.php';
    ...
    public function getServiceMap()
    {
        if (null === $this->_serviceMap) {
            require_once PHP_LIBRARY_PATH.'Zend/Json/Server/Smd.php';
