...
class Zend_Service_Yahoo
{
    ...
    public function inlinkDataSearch($query, array $options = array())
    {
        ...
        if ($response->isError()) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Exception.php';
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/InlinkDataResultSet.php';
    ...
    public function imageSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/ImageResultSet.php';
    ...
    public function localSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/LocalResultSet.php';
    ...
    public function newsSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/NewsResultSet.php';
    ...
    public function pageDataSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/PageDataResultSet.php';
    ...
    public function videoSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/VideoResultSet.php';
    ...
    public function webSearch($query, array $options = array())
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Yahoo/WebResultSet.php';
    ...
    protected function _validateInlinkDataSearch(array $options)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Validate/Between.php';
