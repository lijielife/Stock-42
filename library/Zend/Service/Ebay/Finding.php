 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Abstract.php';
...
class Zend_Service_Ebay_Finding extends Zend_Service_Ebay_Abstract
{
    ...
    protected function _findItems(array $options, $operation)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Response/Items.php';
    ...
    public function getHistograms($categoryId, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Response/Histograms.php';
    ...
    public function getSearchKeywordsRecommendation($keywords, $options = null)
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Response/Keywords.php';
