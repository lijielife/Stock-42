 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Response/Abstract.php';
...
class Zend_Service_Ebay_Finding_Response_Histograms extends Zend_Service_Ebay_Finding_Response_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Aspect/Histogram/Container.php';
        ...
        if ($node) {
             ...
             */
            require_once PHP_LIBRARY_PATH.'Zend/Service/Ebay/Finding/Category/Histogram/Container.php';
