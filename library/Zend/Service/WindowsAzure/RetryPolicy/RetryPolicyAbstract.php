 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/RetryPolicy/NoRetry.php';

/**
 * @see Zend_Service_WindowsAzure_RetryPolicy_RetryN
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/WindowsAzure/RetryPolicy/RetryN.php';
