 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/ResultSet.php';

/**
 * @see Zend_Service_Technorati_Utils
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/Utils.php';
...
class Zend_Service_Technorati_DailyCountsResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function current()
    {
         ...
         */
        require_once PHP_LIBRARY_PATH.'Zend/Service/Technorati/DailyCountsResult.php';
