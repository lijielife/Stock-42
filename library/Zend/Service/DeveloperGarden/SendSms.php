 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SendSms/SendSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SendSms_SendFlashSMSResponse
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Response/SendSms/SendFlashSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendSMS
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SendSms/SendSMS.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendFlashSMS
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/DeveloperGarden/Request/SendSms/SendFlashSMS.php';
