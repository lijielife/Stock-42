...
require_once PHP_LIBRARY_PATH.'Zend/Service/Abstract.php';

/** @see Zend_Json */
require_once PHP_LIBRARY_PATH.'Zend/Json.php';

/** @see Zend_Service_ReCaptcha_Response */
require_once PHP_LIBRARY_PATH.'Zend/Service/ReCaptcha/Response.php';
...
class Zend_Service_ReCaptcha extends Zend_Service_Abstract
{
    ...
    public function setParams($params)
    {
        ...
        if (is_array($params)) {
            ...
            require_once PHP_LIBRARY_PATH.'Zend/Service/ReCaptcha/Exception.php';
