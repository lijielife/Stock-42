 ...
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/Abstract.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Response
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/SimpleDb/Response.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Page
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/SimpleDb/Page.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Attribute
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/SimpleDb/Attribute.php';

/**
 * @see Zend_Service_Amazon_SimpleDb_Exception
 */
require_once PHP_LIBRARY_PATH.'Zend/Service/Amazon/SimpleDb/Exception.php';
